...
var connection_file = config.connectionProvider1;
var appAdmin = config.appAdmin;
var appAdminSecret = config.appAdminSecret;
var orgMSPID = config.org1MSPID;
var caName = config.caOrg1Name;
...
async function main() {
    try {
        ...
        console.error('Failed to enroll user ' + appAdmin + ': ' + error);
        process.exit(1);
    }
}
